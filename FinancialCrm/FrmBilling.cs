...
namespace FinancialCrm
{
    public partial class FrmBilling : Form
    {
        ...
        private void btnBillCreate_Click(object sender, EventArgs e)
        {
            ...
            db.Bills.Add(bills);
            db.SaveChanges();
            MessageBox.Show("Ödeme Başarılı bir Şekilde gerçekleştirildi", "Ödeme & Faturalar", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnBillRemove_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Ödeme Başarılı bir Şekilde Silinmiştir", "Ödeme & Faturalar", MessageBoxButtons.OK, MessageBoxIcon.Information);
